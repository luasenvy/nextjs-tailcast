  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        exit={{ opacity: 0 }}
        className="bg-dark-transparent-darker fixed top-0 left-0 w-full h-screen flex z-50 justify-center items-center"
        onClick={closer}
      >
        <div
          className="w-full h-screen sm:h-auto sm:w-3/4 md:w-3/5 lg:w-[1000px] xl:w-[1100px] sm:rounded-2xl bg-dark-transparent-lighter main-border-gray-darker py-12 px-8 sm:px-16 backdrop-blur-xl sm:mb-8 fixed mx-auto z-50"
          onClick={(e) => e.stopPropagation()}
        >
          <div className="flex relative">
            <div className="w-1/2 hidden lg:inline">
              <h2 className="mt-6 mb-2 text-5xl font-bold tracking-normal text-text-primary">
                Subscribe Now
              </h2>
              <h2 className="text-5xl font-bold tracking-normal text-secondary">
                Winter is coming
              </h2>

              <ul className="mb-6 text-text-primary mt-12">
            ...
            <div className="w-full lg:w-1/2 flex items-center flex-col justify-center pt-24 sm:pt-0">
              <div className="flex inline lg:hidden justify-start items-center grow basis-0 mb-8 pr-6">
                ...
                <div className="text-white font-['Inter'] font-bold text-3xl">Tailcast</div>
              </div>

              <h3 className="mb-7 text-2xl text-text-primary font-bold leading-snug text-center">
              ...
              <div className="flex flex-wrap -m-2">
                ...
                <div className="w-full sm:w-4/5 p-2 mt-4 mx-auto">
                  <button
                    className="py-4 px-6 w-full text-text-primary font-semibold rounded-xl shadow-4xl focus:ring focus:ring-indigo-300 bg-primary hover:bg-[#7274f3] transition ease-in-out duration-200"
                    type="button"
                    aria-label="Join now"
                  >
                    Join Now
