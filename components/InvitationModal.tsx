...
export default function InvitationModal({ closer }: InvitationModalProps) {
  return (
    <AnimatePresence>
      <motion.div
        ...
        exit={{ opacity: 0 }}
        className="bg-bgDarkTransparentDarker fixed top-0 left-0 w-full h-screen flex  z-50 justify-center items-center"
        onClick={closer}
      >
        <div
          className="w-full h-screen sm:h-auto sm:w-3/4 md:w-3/5 lg:w-[1000px] xl:w-[1100px] sm:rounded-2xl bg-bgDarkTransparentLighter main-border-gray-darker py-12 px-8 sm:px-16 backdrop-blur-xl sm:mb-8 fixed mx-auto z-50"
