...
export function Blog() {
  return (
    <section className="w-screen flex justify-center bg-dark2 relative">
      ...
      <div className="pb-0 pt-4 bg-dark2 2xl:w-[1200px] lg:w-[1000px] xl:w-[1150px]">
        <motion.div
          initial={{ opacity: 0 }}
            ...
            <div className="flex 2xl:w-[1200px] lg:w-[1000px] xl:w-[1150px] flex-wrap -mx-4 items-start h-auto sm:h-[30rem] lg:h-[31rem] xl:h-[35rem]">
              <div className="flex sm:hidden lg:flex w-11/12 mx-auto sm:ml-0 sm:mr-0 lg:w-1/2 xl:w-3/5 px-4 mb-8 lg:mb-0 h-full">
                <Link href="/blog/article">
                  <div className="p-6 sm:p-10 bg-dark3 rounded-3xl h-full hover:bg-dark3-hover transition cursor-pointer">
                    <Image
                    ...
                    />
                    <h3 className="mb-4 text-2xl font-bold font-heading text-text-primary">
                      {blogData[0].title}
                    </h3>
              ...
              <div className="hidden sm:flex mx-auto lg:ml-0 lg:mr-0 w-11/12 sm:w-4/5 lg:w-1/2 xl:w-2/5 px-4 flex-col justify-between h-full">
                {blogData.slice(1).map((post, index) => (
                  <Link
                    ...
                    className=" flex gap-4 p-10 bg-dark3 rounded-3xl min-h-1/2 h-1/2 max-h-[47%]
                  hover:bg-dark3-hover transition cursor-pointer"
                  >
                    <div className="pt-2">
                      <h3 className="mb-4 text-xl font-bold font-heading text-text-primary">
                        {post.title}
                      </h3>
